...
export const S = {
  ...
  releaseToDelete: 'Отпусти, чтобы удалить вершину',
  okCopied: 'JSON скопирован',
  okImported: 'Сцена загружена как новый вариант',
  okSaved: 'Файл сохранён',
  okShared: 'Отправлено',
  errCopy: 'Не удалось скопировать — скопируй из поля вручную',
  importTitle: 'Импорт сцены',
  importPickFile: 'Выбрать файл',
  importHint: 'Сцена приедет новым вариантом. Текущий не тронем.',
  resetWarn: 'Удалить все варианты и начать с чистой комнаты?',
